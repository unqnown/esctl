...
import (
	...
	"github.com/unqnown/esctl/app/top/node"
...
func cluster(_ config.Config, conn *client.Client, _ *cli.Context) error {
...
func indices(_ config.Config, conn *client.Client, c *cli.Context) error {
